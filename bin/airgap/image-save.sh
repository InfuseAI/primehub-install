...
IMAGE_SEARCH=(
  ${PHROOT}/modules/*/images.yaml
  ${PHROOT}/modules/charts/*/images.yaml
)
...
print_usage() {
  ...
  echo "Examples: "
  echo "  # list groups"
  echo "  `basename $0` --list-groups"
  echo ""
  echo "  # list images for one group"
  echo "  `basename $0` --list-images primehub-ee"
  echo ""
  echo "  # build images for one group"
  echo "  `basename $0` primehub-ee"
  echo ""
  echo "  # build images to a output prefix"
  echo "  `basename $0` -o primehub-images-ee-v1.0.0 primehub-ee"
  echo ""
